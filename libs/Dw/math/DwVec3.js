...
DwVec3.nullvector = function () {
  return [0, 0, 0];
}


DwVec3.copy_ref = function (a, dst) {
  dst[0] = a[0];
  dst[1] = a[1];
  dst[2] = a[2];
};

DwVec3.copy_new = function (a) {
  return [a[0], a[1], a[2]];
};


DwVec3.equals = function (a, b) {
...
DwVec3.multiply_ref = function (a, b, dst) {
  dst[0] = a[0] * b[0];
  dst[1] = a[1] * b[1];
  dst[2] = a[2] * b[2];
};
DwVec3.multiply_new = function (a, b) {
  return [a[0]*b[0], a[1]*b[1], a[2]*b[2]];
};
